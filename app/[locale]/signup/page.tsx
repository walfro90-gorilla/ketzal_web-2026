        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl relative z-10 backdrop-blur-sm my-10">
                <div className="flex flex-col items-center mb-8">
                    <h1 className="text-3xl font-black tracking-tighter text-white mb-2">{t('signup_title')}</h1>
                    <p className="text-gray-400 text-sm text-center">{t('signup_subtitle')}</p>
                </div>
                ...
                <form action={formAction} className="space-y-4">
                    ...
                    {/* Role Selection */}
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-300 ml-1">{t('role')}</label>
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="w-full bg-[#1a1a1a] border border-white/10 focus:border-primary/50 text-white rounded-xl pl-10 pr-4 py-3 outline-none transition-all appearance-none cursor-pointer"
                            >
                                <option value="traveler">{t('role_traveler')}</option>
                                <option value="provider">{t('role_provider')}</option>
                                <option value="ambassador">{t('role_ambassador')}</option>
                                {/* Admin role is generally hidden or special, but included per request "all possible roles" */}
                                <option value="admin">Admin</option>
                            </select>
                            {/* Chev down icon could be added here for better UI */}
                        </div>
                    </div>
